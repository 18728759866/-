        ...
        <div class="login_form">
            <div class="login_box">
                ...
                <div class="msg_cont">
                    <b></b>
                    <span id="ErrorMsg">
                        ${ empty sessionScope.message5 ? "请您输入目标信息":sessionScope.message5}
                    </span>
                </div>
                <div class="form">
                    <form action="http://localhost:8080/LastProject_war/creatrespondent" method="post">
                        <input type="hidden" name="action" value="login" />
                        <label>目标名称：</label>
                        <input class="itxt" type="text" placeholder="请输入目标名"
                               autocomplete="off" tabindex="1" name="name"/>
                        <br />
                        <br />
                        <label>目标介绍：</label>
                        <input class="itxt" type="text" placeholder="请输入介绍"
                               autocomplete="off" tabindex="1" name="introduce" />
                        <br />
                        <br />
